...
function Setup() {
    ...
    Resize();
	getFeedXMLDOM();
 	window.setInterval(getFeedXMLDOM, (30 * 60000));	
...
function SystemSetup()
{
    ...
    {
      DefaultFeed = "http://feeds.feedburner.com/innovatewithgadgets";
...
{
    URLFeeds[0] = "http://feeds.feedburner.com/innovatewithgadgets";
    URLFeedsW[0] = 600;
    URLFeedsH[0] = 600;
    
    URLFeeds[1] = "http://feeds.feedburner.com/WidgetsForWeb20";
    URLFeedsW[1] = 700;
    URLFeedsH[1] = 600;
    
    URLFeeds[2] = "http://feeds.feedburner.com/TrickOfMind";
    URLFeedsW[2] = 400;
    URLFeedsH[2] = 300;
}
